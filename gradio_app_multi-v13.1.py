...
# ------------------------------------------------------------
# Core generation (v13 with do_all_profiles + per-run folder)
# ------------------------------------------------------------
...
def _generate_single_profile(
    ...
    """
    Helper: generate images for a single style profile in a multi-profile run.
    All files go into run_dir with run_timestamp in the filename.
    """
...
def generate_images(
    ...
    try:
        ...
        if do_all_profiles:
            ...
            # Dedicated folder for this multi-profile run
            ...
            for idx, prof_name in enumerate(profile_names):
                ...
                # Use widely spaced seeds per profile so there's no overlap
...
if __name__ == "__main__":
    ui = build_ui()
    ui.launch(server_name="0.0.0.0", server_port=7869)
